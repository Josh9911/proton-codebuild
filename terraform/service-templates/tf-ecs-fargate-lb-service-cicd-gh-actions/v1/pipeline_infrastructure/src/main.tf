    ...
    policy = jsonencode({
      ...
      Statement = [
        ...
        },
        {
          ...
          Resource = "arn:aws:proton:ap-southeast-1:${data.aws_caller_identity.current.account_id}:service/${var.proton_service}"
        },
        {
          Effect = "Allow"
          Action = [
          ...
          Resource = "arn:aws:proton:ap-southeast-1:${data.aws_caller_identity.current.account_id}:service/${var.proton_service}/service-instance/*"
        },
      ]
    })
  }
